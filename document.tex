...
\newcommand{\examinerC}{Oswald D. Sapang}

\newcommand{\examinerDTitle}{Engr.} 
\newcommand{\examinerD}{Roderick Y. Yap}
...
\newcommand{\approvalDate}{May~27,~\the\year} % put here the date when all examiners and/or their approved representative have given their approval; do not remove the tildes in order to not break the date; the submission deadline can also be placed as the date
